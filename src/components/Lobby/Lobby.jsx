...
const Lobby = () => {
  ...
  //dummy
  const roomList = [
    { isLock: false, roomNo: 1, title: "1번방", numOfPeople: 6, standby: false },
    { isLock: false, roomNo: 2, title: "rty", numOfPeople: 1, standby: true },
    { isLock: false, roomNo: 3, title: "jhj", numOfPeople: 3, standby: true },
    { isLock: false, roomNo: 4, title: "cvb", numOfPeople: 4, standby: true },
    { isLock: true, roomNo: 5, title: "asd", numOfPeople: 6, standby: false },
    { isLock: true, roomNo: 6, title: "asd", numOfPeople: 3, standby: true },
    { isLock: true, roomNo: 7, title: "df", numOfPeople: 1, standby: true },
    { isLock: true, roomNo: 8, title: "dd", numOfPeople: 6, standby: false },
    { isLock: true, roomNo: 9, title: "qqw", numOfPeople: 3, standby: true },
    { isLock: true, roomNo: 10, title: "dfg", numOfPeople: 6, standby: true },
    { isLock: true, roomNo: 11, title: "dfg", numOfPeople: 3, standby: true },
  ];
